...
import { SiCplusplus, SiFastapi, SiPostgresql, SiMongodb, SiFirebase, SiScala, SiFlask, SiTypescript, SiRedis, SiApachekafka, SiDigitalocean, SiGooglecloud, SiMicrosoftazure, SiKubernetes, SiHelm } from 'react-icons/si';
...
const skillsData = {
  languages: [
    ...
    { name: "C++", value: 4, icon: <SiCplusplus size={rem(20)} /> },
    { name: "Java", value: 3, icon: <FaJava size={rem(20)} /> },
    { name: "Scala", value: 1, icon: <SiScala size={rem(20)} /> },
  ],
  tools: [
    { name: "Helm", value: 4, icon: <SiHelm size={rem(20)} /> },
    { name: "Flask", value: 5, icon: <SiFlask size={rem(20)} /> },
    { name: "FastAPI", value: 3, icon: <SiFastapi size={rem(20)} /> },
    { name: "React.js", value: 5, icon: <FaReact size={rem(20)} /> },
    { name: "React Native", value: 5, icon: <FaReact size={rem(20)} /> },
  ...
  databases: [
    ...
    { name: "Redis", value: 3, icon: <SiRedis size={rem(20)} /> },
    { name: "Kafka", value: 4, icon: <SiApachekafka size={rem(20)} /> },
    { name: "MongoDB", value: 3, icon: <SiMongodb size={rem(20)} /> },
    { name: "Firebase", value: 3, icon: <SiFirebase size={rem(20)} /> },
  ],
  cloud: [
    { name: "Kubernetes", value: 3, icon: <SiKubernetes size={rem(20)} /> },
    { name: "DigitalOcean", value: 4, icon: <SiDigitalocean size={rem(20)} /> },
    { name: "Google Cloud", value: 3, icon: <SiGooglecloud size={rem(20)} /> },
